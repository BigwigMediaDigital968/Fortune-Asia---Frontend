              ...
              {clients.map((client, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`absolute inset-0 bg-gradient-to-br from-white/10 to-transparent  group-hover:opacity-100 transition-opacity rounded-[2rem] ${isActive ? "opacity-100" : "opacity-0"}`}
                    />
                    ...
                    <div
                      className={`absolute -bottom-px left-1/2 -translate-x-1/2 w-1/3 h-px bg-gradient-to-r from-transparent via-gold-400 to-transparent group-hover:opacity-100 transition-opacity ${isActive ? "opacity-100" : "opacity-0 "}`}
                    />
                  </motion.div>
                );
              })}
