        ...
        >
          {features.map((f, i) => (
            <motion.div
              ...
              className="bg-white rounded-2xl p-8 border border-border group cursor-pointer"
            >
              <div className="w-14 h-14 rounded-xl bg-navy-50 text-navy-900 flex items-center justify-center mb-6 group-hover:bg-navy-900 group-hover:text-white transition-all duration-300">
                {f.icon}
              </div>
              <h3 className="font-display text-navy-900 text-2xl font-semibold mb-3">
                {f.title}
              </h3>
              <p className="font-sans text-charcoal-500 text-sm leading-relaxed mb-6">
                {f.desc}
              </p>
              <a
                href="#"
                className="inline-flex items-center gap-2 text-xs font-sans font-semibold tracking-widest uppercase text-gold-500 group-hover:gap-3 transition-all duration-200"
              >
                {f.cta}
                <svg
                  width="14"
