                            ...
                            >
                                <div className="relative rounded-[40px] overflow-hidden mb-6 aspect-[4/5] shadow-2xl">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-navy-950 via-transparent to-transparent opacity-0 group-hover:opacity-80 transition-opacity duration-500 flex flex-col justify-end p-8">
                                        <button className="cursor-pointer w-full py-4 bg-gold-400 text-white font-bold uppercase text-[10px] tracking-widest rounded-full opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
                                            View Details
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="px-2">
                                    <div className="flex justify-between items-start mb-3">
                                        <h3 className="text-2xl font-serif font-bold text-white group-hover:text-gold-400 transition-colors">{prop.title}</h3>
                                        <p className="text-gold-400 font-bold text-lg">{prop.price}</p>
                                    </div>
                                    <div className="flex items-center gap-2 text-white text-xs mb-6">
                                        <MapPin size={12} className="text-gold-400" /> {prop.location}
                                    </div>
