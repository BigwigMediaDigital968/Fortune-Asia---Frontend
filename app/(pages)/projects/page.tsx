...
const PROJECTS_DATA = [
  {
    ...
    description:
      "Sky Bay Real Estate is a dynamic property consultancy in Dubai, dedicated to connecting buyers, sellers, and investors with premium real estate opportunities.",
  },
  {
    id: 2,
    title: "Azure Bay",
    ...
    image:
      "https://images.unsplash.com/photo-1462396240927-52058a6a84ec?q=80&w=1073",
    description:
      "Sky Bay Real Estate is a dynamic property consultancy in Dubai, dedicated to connecting buyers, sellers, and investors with premium real estate opportunities.",
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1460472178825-e5240623afd5?q=80&w=1169",
    description:
      "Sky Bay Real Estate is a dynamic property consultancy in Dubai, dedicated to connecting buyers, sellers, and investors with premium real estate opportunities.",
  },
  {
  ...
  return (
    <main className="bg-navy-950 min-h-screen text-white">
      ...
      <PageHero
        ...
        title={
          <>
            Our <span className="text-gold-400"> Signature Projects</span>
          </>
        }
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-white/60 text-lg mb-12 max-w-2xl mx-auto">
              Our advisors specialize in identifying high-growth off-plan
              opportunities tailored to your investment objectives.
            </p>
